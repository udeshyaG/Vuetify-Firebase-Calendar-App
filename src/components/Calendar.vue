    ...
    <v-col>
      <v-sheet height="64">
        <v-toolbar flat color="white">
          ...
          <v-btn color="primary" class="mr-2" v-on:click="dialog = true">New Event</v-btn>
          ...
          <v-toolbar-title class="ml-4" v-if="$refs.calendar">{{ $refs.calendar.title }}</v-toolbar-title>
          <v-spacer></v-spacer>
          <v-menu bottom right>
        ...
        <v-card>
          <v-container>
            <v-form v-on:submit.prevent="addEvent">
              ...
              <v-btn type="submit" color="success" v-on:click.stop="dialog= false">Create Event</v-btn>
            </v-form>
          </v-container>
        </v-card>
      </v-dialog>
        ...
        >
          <v-card color="grey lighten-4" min-width="350px" flat>
            <v-toolbar :color="selectedEvent.color" dark>
              <v-btn icon v-on:click="deleteEvent(selectedEvent.id)">
            ...
            <v-card-actions>
              ...
              <v-btn
                ...
                v-on:click.prevent="editEvent(selectedEvent)"
              >Edit</v-btn>

              <!-- Save Button -->
              <v-btn text v-else v-on:click="updateEvent(selectedEvent)">Save</v-btn>
            </v-card-actions>
          </v-card>
        </v-menu>
      </v-sheet>
